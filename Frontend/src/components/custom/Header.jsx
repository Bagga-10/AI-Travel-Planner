...
function Header() {
  ...
  return (
    <header className="p-3 shadow-sm flex justify-between items-center px-5 bg-white dark:bg-gray-900 dark:text-white">
      ...
      {user && (
        <h2 className="font-serif absolute left-1/2 transform -translate-x-1/2 text-3xl font-semibold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-pulse">
          {welcomeText}
        </h2>
      )}
